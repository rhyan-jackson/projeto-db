/* ============================================================
   Seed data para a BD p4g5
   Corre este script no SSMS DEPOIS do script.sql.
...
(1, 1),  -- TechFair: Setor A
(2, 1),  -- TechFair: Setor B
(3, 2),  -- FoodExpo: Doces
(4, 2),  -- FoodExpo: Bebidas
(5, 3);  -- AutoShow: Carros
GO
...
/* ----------------- 7) Relacao permite (tipo->setor) --------- */
INSERT INTO dbo.permite(id_tipo, id_setor) VALUES
(1, 1), (1, 2), (1, 3), (1, 4), (1, 5),  -- Geral: tudo
(2, 1), (2, 2), (2, 3), (2, 4), (2, 5),  -- VIP: tudo
(3, 1), (3, 2),                            -- Expositor: setores 1 e 2
(4, 1), (4, 2), (4, 3), (4, 4), (4, 5);  -- Imprensa: tudo
GO
